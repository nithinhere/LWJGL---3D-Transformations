/**
 * A substitute for java.awt.Color since it can't be used in the same
 * application as LWJGL3 on Mac OS X.
 *
 * @author rdb 9/29/15 02/05/17 rdb Added get3f and get4f to return color
 *         components in a 3 or 4 float array
 */
public class Color {
	// ---------------- instance variables ------------------------
	private float red;
